...
class TiempoSimple{
	...
	/* si el constructor utiliza nombres de párametros idénticos a los nombres de las 
	...
	public String aStringUniversal() {
		/* "this" no se requiere aquí para acceder a las variables 
		 * de instancia, ya que el método no tiene variables locales 
